...
router.post('/add-product', function(req, res) {
    ...
    req.checkBody('title', 'Tên không được để trống.').notEmpty();
    req.checkBody('desc', 'Mô tả không được để trống.').notEmpty();
    req.checkBody('price', 'Giá không được để trống.').isDecimal();
    req.checkBody('image', 'Phải tải ảnh lên').isImage(imageFile);
